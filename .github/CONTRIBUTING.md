# zefio contribution guidelines

## Crashes & Bugs
Log them in the [Issues](https://github.com/OxygenCobalt/zefio/issues) tab.
...
If you have knowledge of Android/Kotlin in general, you could also go about fixing the bug yourself and opening a [Pull Request](https://github.com/OxygenCobalt/zefio/pulls).

## Feature Requests
These should also be logged in the [Issues](https://github.com/OxygenCobalt/zefio/issues) tab.
...
- **Will it be accepted?** Read the [Why Are These Features Missing?](https://github.com/OxygenCobalt/zefio/wiki/Why-Are-These-Features-Missing%3F) in order to see the likelihood that your request will be implemented.
...
If you have the knowledge, you can also implement the feature yourself and create a [Pull Request](https://github.com/OxygenCobalt/zefio/pulls), but its recommended that **you create an issue beforehand to give me a heads up.**
Its also recommended that you read about [zefio's Architecture](https://github.com/OxygenCobalt/zefio/wiki/Architecture) as well to make changes better and more efficient.

## Translations
Go to zefio's weblate project [here](https://hosted.weblate.org/engage/zefio/).
...
- Make sure you stick to zefio's styling, which should be auto-formatted on every build.
